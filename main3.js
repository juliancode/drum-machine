...
var oneBeatTime = (60 / Sequencer.tempo)
var oneBarTime = oneBeatTime * 4
var numberOfBars = 8
var totalSequencer = oneBarTime * numberOfBars
...
Sample = function(filename) {
  ...
  this.playSequencer = function(step) {
...
$('.sequencer-buttons').click(function() {
  ...
  if (this.pressed) {
    Sequencer["config"][drum].splice($.inArray(step,Sequencer["config"][drum]),1); 
    $(this).css("background", "");
    this.pressed = false;
  }
  else {
    Sequencer["config"][drum].push(step);
